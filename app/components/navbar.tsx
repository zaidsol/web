...
function Navbar() {
    ...
    <div className="relative">
      ...
      <div className="mx-auto px-4 py-2 flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          <Link href="/slider">
            <img src="/lg.png" alt="Logo" className="ml-4 h-25 w-auto" />
          </Link>
        </div>
  ...
  <div className="w-full md:w-1/3 max-h-screen overflow-y-auto font-semibold bg-white shadow-lg rounded-lg py-4 px-10 space-y-4 absolute top-0 left-0 mt-2 transform transition-all duration-300 ease-in-out z-50">
          ...
          <div className="flex justify-center space-x-2  ">
            <Link href="/contactuss"><div className="border rounded-2xl flex flex-col items-center p-2  ">
          <PhoneIncoming  className="h-12 "/>
          <p className="text-xs">contact us</p>
          </div></Link>
          <Link href="/testing"><div className="border rounded-2xl flex flex-col items-center p-2 ">
          ...
          <div className="flex justify-between">
            <Link href="#" className="text-yellow-500  hover:bg-blue-100 py-2 px-4 rounded-lg transition-colors duration-200">
