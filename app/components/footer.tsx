...
import { PhoneCallIcon,Mail ,VideoIcon, BoxIcon, SquarePlay,SquareChartGantt} from 'lucide-react';
    ...
    <div className="bg-gray-200 text-gray-600  px-4 py-12 flex items-center ">
      ...
      <div className="flex flex-col md:flex-row  justify-between gap-14">
        ...
        <div className='space-y-6 '>
          ...
          <p className=' flex gap-2'> <Mail></Mail> email@gmail.com</p>
          <p className='flex gap-2'><PhoneCallIcon></PhoneCallIcon> 0224242</p>
          <div className='flex'>
        ...
        <div className='w-60'>
          ...
          <p className="mb-8">Subscribe to our newslette for evey hwhwh dhwhdr:</p>
          ...
          <div className='flex'>
            <img  className='w-15 h-10' src="./icon2.png"></img>
             <img  className='w-15 h-10' src="./icon1.png"></img>
               <img  className='w-15 h-10' src="./icon2.png"></img>
                 <img  className='w-15 h-10' src="./icon1.png"></img>
       ...
       <p className='text-gray-600'>copyright @2024 Saya all reserved it is noted thta our legay </p>
    </div>
  );
}
